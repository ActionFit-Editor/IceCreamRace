...
Unity Test Framework의 EditMode에서 `com.actionfit.icecream-race.Editor.Tests`를 실행합니다. catalog 동등성, 참가 인원/컷, 실시간 순위, 배율, 표시 snapshot 제한/복구, timeout, serializer, 보상 지급 전·후 재실행 복구를 검증합니다.
